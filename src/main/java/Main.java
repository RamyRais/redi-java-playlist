...
//
//Our streaming service should have one player, that, once it is invoked with a track, will print "Now playing: <artist_name> - <track_name>".
//
...
//Our business-model is simple and we have to pay by the number of streams that happened. Therefore our business wants to know:
//
